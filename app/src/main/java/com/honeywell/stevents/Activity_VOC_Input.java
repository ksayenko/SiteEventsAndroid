...
public class Activity_VOC_Input extends AppCompatActivity implements BarcodeReader.BarcodeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        current_unit = default_site_event_reading.getUnit();
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (Objects.equals(current_se, "NA")) {
                    ...
                    //spin_Loc_id.setSelection(id);
                    //barcodeList.setAdapter(dataAdapter);
                    Toast.makeText(Activity_VOC_Input.this, "No data yet", Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(Activity_VOC_Input.this, current_se, Toast.LENGTH_SHORT).show();
